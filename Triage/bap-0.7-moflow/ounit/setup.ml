...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3898e020bbe0544be241273d25b44d1b) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-ounit", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-ounit", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2002-2008 Maas-Maarten Zeeman"; "(C) 2010 OCamlCore SARL"];
          maintainers = [];
          authors = ["Maas-Maarten Zeeman"; "Sylvain Le Gall"];
          homepage = Some "http://ounit.forge.ocamlcore.org";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable backtrace display in exception";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "oUnit"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for OUnit";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\184<\231n\240\011uzpZ]\"~\207\162#";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
