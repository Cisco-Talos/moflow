...
# Generated by GNU Autoconf 2.68 for Bap 0.7.
#
# Report bugs to <bap-dev@lists.andrew.cmu.edu>.
#
#
...
$0: bap-dev@lists.andrew.cmu.edu about your system,
...
PACKAGE_TARNAME='bap'
PACKAGE_VERSION='0.7'
PACKAGE_STRING='Bap 0.7'
PACKAGE_BUGREPORT='bap-dev@lists.andrew.cmu.edu'
PACKAGE_URL=''

ac_unique_file="libasmir/src/asm_program.c"
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures Bap 0.7 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/bap]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of Bap 0.7:";;
   esac
  cat <<\_ACEOF
...
Optional Features:
  ...
  --enable-opt            use optimized versions of ocaml tools (default)

Optional Packages:
  --with-PACKAGE[=ARG]    use PACKAGE [ARG=yes]
  --without-PACKAGE       do not use PACKAGE (same as --with-PACKAGE=no)
  --with-z3               location of Z3 library
  --with-llvm=[=ARG]      use OCaml llvm package named ARG
...
$as_echo "$as_me: WARNING: $2: proceeding with the compiler's result" >&2;}
( $as_echo "## ------------------------------------------- ##
## Report this to bap-dev@lists.andrew.cmu.edu ##
## ------------------------------------------- ##"
...
It was created by Bap $as_me 0.7, which was
...
ac_config_headers="$ac_config_headers libasmir/config.h"
...
if test "${enable_opt+set}" = set; then :
  enableval=$enable_opt; case "$enableval" in
            yes) ac_ocaml_enable_opt=$enableval;;
            no)  ac_ocaml_enable_opt=$enableval;;
            *)   as_fn_error $? "bad value $enableval for --enable-opt" "$LINENO" 5;;
        esac
else
...
$as_echo "$OCAMLVERSION" >&6; }
    ...
    if test -n "3.12.0"; then
        ac_ocaml_min_version="3.12.0";
        # Checking for OCaml minimum version
        { $as_echo "$as_me:${as_lineno-$LINENO}: checking whether OCaml version >= $ac_ocaml_min_version" >&5
$as_echo_n "checking whether OCaml version >= $ac_ocaml_min_version... " >&6; }
...
$as_echo "yes" >&6; }
            ...
            { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
            as_fn_error $? "OCaml version unsufficient. See 'Bootstrapping using ocamlbrew' in the INSTALL file." "$LINENO" 5
        fi
    fi
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_OCAMLC_OPT+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $OCAMLC_OPT in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_OCAMLC_OPT="$OCAMLC_OPT" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if { test -f "$as_dir/$ac_word$ac_exec_ext" && $as_test_x "$as_dir/$ac_word$ac_exec_ext"; }; then
    ac_cv_path_OCAMLC_OPT="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
OCAMLC_OPT=$ac_cv_path_OCAMLC_OPT
if test -n "$OCAMLC_OPT"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $OCAMLC_OPT" >&5
$as_echo "$OCAMLC_OPT" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
fi
    ...
    if test -z "$OCAMLC_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamlc.opt" >&5
$as_echo "$as_me: WARNING: Cannot find ocamlc.opt" >&2;}
    fi

        if test -n "$OCAMLC_OPT"; then


    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for ocamlc.opt version" >&5
$as_echo_n "checking for ocamlc.opt version... " >&6; }
    ac_ocaml_check_version=`$OCAMLC_OPT -version`
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_ocaml_check_version" >&5
$as_echo "$ac_ocaml_check_version" >&6; }
    if test "$ac_ocaml_check_version" != "$OCAMLVERSION"; then
        unset OCAMLC_OPT
    fi

    if test -z "$OCAMLC_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: ocamlc.opt version differs from ocamlc, discarding" >&5
$as_echo "$as_me: WARNING: ocamlc.opt version differs from ocamlc, discarding" >&2;}
    fi
...
$as_echo "$as_me: WARNING: Cannot find ocamlopt; bytecode compilation only" >&2;}
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for ocamlopt version" >&5
$as_echo_n "checking for ocamlopt version... " >&6; }
    ac_ocaml_check_version=`$OCAMLOPT -version`
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_ocaml_check_version" >&5
$as_echo "$ac_ocaml_check_version" >&6; }
    if test "$ac_ocaml_check_version" != "$OCAMLVERSION"; then
        unset OCAMLOPT
    ...
    if test -z "$OCAMLOPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: ocamlopt version differs from ocamlc, discarding" >&5
$as_echo "$as_me: WARNING: ocamlopt version differs from ocamlc, discarding" >&2;}
    fi
    ...
    if test -n "$OCAMLOPT"; then
        ...
        { $as_echo "$as_me:${as_lineno-$LINENO}: checking if OCaml C compiler works" >&5
$as_echo_n "checking if OCaml C compiler works... " >&6; }
...
$as_echo "yes" >&6; }
            ...
            { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
            { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: bytecode compilation only" >&5
$as_echo "$as_me: WARNING: bytecode compilation only" >&2;}
            unset OCAMLOPT
        fi
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_OCAMLOPT_OPT+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $OCAMLOPT_OPT in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_OCAMLOPT_OPT="$OCAMLOPT_OPT" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if { test -f "$as_dir/$ac_word$ac_exec_ext" && $as_test_x "$as_dir/$ac_word$ac_exec_ext"; }; then
    ac_cv_path_OCAMLOPT_OPT="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
OCAMLOPT_OPT=$ac_cv_path_OCAMLOPT_OPT
if test -n "$OCAMLOPT_OPT"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $OCAMLOPT_OPT" >&5
$as_echo "$OCAMLOPT_OPT" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
fi
    ...
    if test -z "$OCAMLOPT_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamlopt.opt" >&5
$as_echo "$as_me: WARNING: Cannot find ocamlopt.opt" >&2;}
    fi

        if test -n "$OCAMLOPT_OPT"; then


    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for ocamlopt.opt version" >&5
$as_echo_n "checking for ocamlopt.opt version... " >&6; }
    ac_ocaml_check_version=`$OCAMLOPT_OPT -version`
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_ocaml_check_version" >&5
$as_echo "$ac_ocaml_check_version" >&6; }
    if test "$ac_ocaml_check_version" != "$OCAMLVERSION"; then
        unset OCAMLOPT_OPT
    ...
    if test -z "$OCAMLOPT_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: ocamlopt.opt version differs from ocamlc, discarding" >&5
$as_echo "$as_me: WARNING: ocamlopt.opt version differs from ocamlc, discarding" >&2;}
    fi
...
$as_echo "no" >&6; }
    ...
    if test -z "$OCAMLDEP"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamldep" >&5
$as_echo "$as_me: WARNING: Cannot find ocamldep" >&2;}
    fi
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_OCAMLDEP_OPT+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $OCAMLDEP_OPT in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_OCAMLDEP_OPT="$OCAMLDEP_OPT" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if { test -f "$as_dir/$ac_word$ac_exec_ext" && $as_test_x "$as_dir/$ac_word$ac_exec_ext"; }; then
    ac_cv_path_OCAMLDEP_OPT="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
OCAMLDEP_OPT=$ac_cv_path_OCAMLDEP_OPT
if test -n "$OCAMLDEP_OPT"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $OCAMLDEP_OPT" >&5
$as_echo "$OCAMLDEP_OPT" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
fi
    ...
    if test -z "$OCAMLDEP_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamldep.opt" >&5
$as_echo "$as_me: WARNING: Cannot find ocamldep.opt" >&2;}
    fi
...
$as_echo "no" >&6; }
    ...
    if test -z "$OCAMLMKTOP"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamlmktop" >&5
...
$as_echo "no" >&6; }
    ...
    if test -z "$OCAMLMKLIB"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamlmklib" >&5
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_OCAMLDOC_OPT+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $OCAMLDOC_OPT in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_OCAMLDOC_OPT="$OCAMLDOC_OPT" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if { test -f "$as_dir/$ac_word$ac_exec_ext" && $as_test_x "$as_dir/$ac_word$ac_exec_ext"; }; then
    ac_cv_path_OCAMLDOC_OPT="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
OCAMLDOC_OPT=$ac_cv_path_OCAMLDOC_OPT
if test -n "$OCAMLDOC_OPT"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $OCAMLDOC_OPT" >&5
$as_echo "$OCAMLDOC_OPT" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
fi
    ...
    if test -z "$OCAMLDOC_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamldoc.opt" >&5
$as_echo "$as_me: WARNING: Cannot find ocamldoc.opt" >&2;}
    fi
...
$as_echo "no" >&6; }
    ...
    if test -z "$OCAMLLEX"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamllex" >&5
$as_echo "$as_me: WARNING: Cannot find ocamllex" >&2;}
    fi
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_OCAMLLEX_OPT+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $OCAMLLEX_OPT in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_OCAMLLEX_OPT="$OCAMLLEX_OPT" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if { test -f "$as_dir/$ac_word$ac_exec_ext" && $as_test_x "$as_dir/$ac_word$ac_exec_ext"; }; then
    ac_cv_path_OCAMLLEX_OPT="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
OCAMLLEX_OPT=$ac_cv_path_OCAMLLEX_OPT
if test -n "$OCAMLLEX_OPT"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $OCAMLLEX_OPT" >&5
$as_echo "$OCAMLLEX_OPT" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
fi
    ...
    if test -z "$OCAMLLEX_OPT"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamllex.opt" >&5
$as_echo "$as_me: WARNING: Cannot find ocamllex.opt" >&2;}
    fi
...
$as_echo "no" >&6; }
    ...
    if test -z "$OCAMLYACC"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find ocamlyacc" >&5
$as_echo "$as_me: WARNING: Cannot find ocamlyacc" >&2;}
    fi
...
$as_echo "no" >&6; }
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for camlp4 version" >&5
$as_echo_n "checking for camlp4 version... " >&6; }
    ac_ocaml_check_version=`$CAMLP4 -version`
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_ocaml_check_version" >&5
$as_echo "$ac_ocaml_check_version" >&6; }
    if test "$ac_ocaml_check_version" != "$OCAMLVERSION"; then
        unset CAMLP4
    ...
    if test -z "$CAMLP4"; then
        as_fn_error $? "camlp4 version differs from ocamlc, aborting" "$LINENO" 5
    fi
...
$as_echo "no" >&6; }
    ...
    if test -z "$CAMLP4OF"; then
        as_fn_error $? "Cannot find camlp4of" "$LINENO" 5
    fi
...
$as_echo "no" >&6; }
    ...
    if test -z "$CAMLP4R"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Cannot find camlp4r" >&5
$as_echo "$as_me: WARNING: Cannot find camlp4r" >&2;}
    fi


    # Searching for parser library path
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for CamlP4 library path" >&5
$as_echo_n "checking for CamlP4 library path... " >&6; }
    CAMLP4LIB=`$CAMLP4 -where`
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $CAMLP4LIB" >&5
$as_echo "$CAMLP4LIB" >&6; }
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_CAMLIDL+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $CAMLIDL in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_CAMLIDL="$CAMLIDL" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if { test -f "$as_dir/$ac_word$ac_exec_ext" && $as_test_x "$as_dir/$ac_word$ac_exec_ext"; }; then
    ac_cv_path_CAMLIDL="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
$as_echo "no" >&6; }
    ...
    if test -z "$CAMLIDL"; then
        as_fn_error $? "Cannot find camlidl" "$LINENO" 5
    fi
...
if test "${with_z3+set}" = set; then :
  withval=$with_z3; with_z3=$withval
else
  with_z3=no
fi
...
if test "x$with_z3" != "xno"; then :
     ...
     { $as_echo "$as_me:${as_lineno-$LINENO}: checking for Z3_mk_bvadd in -lz3" >&5
$as_echo_n "checking for Z3_mk_bvadd in -lz3... " >&6; }
if ${ac_cv_lib_z3_Z3_mk_bvadd+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
_ACEOF
if ac_fn_c_try_link "$LINENO"; then :
  ac_cv_lib_z3_Z3_mk_bvadd=yes
else
  ac_cv_lib_z3_Z3_mk_bvadd=no
fi
rm -f core conftest.err conftest.$ac_objext \
    conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_z3_Z3_mk_bvadd" >&5
$as_echo "$ac_cv_lib_z3_Z3_mk_bvadd" >&6; }
if test "x$ac_cv_lib_z3_Z3_mk_bvadd" = xyes; then :

        z3_dir=$with_z3
        with_z3=yes

$as_echo "#define HAVE_Z3_BINDINGS 1" >>confdefs.h


else
  { { $as_echo "$as_me:${as_lineno-$LINENO}: error: in \`$ac_pwd':" >&5
$as_echo "$as_me: error: in \`$ac_pwd':" >&2;}
as_fn_error $? "z3 library not found
See \`config.log' for more details" "$LINENO" 5; }
fi
...
as_ac_File=`$as_echo "ac_cv_file_$PIN_HOME" | $as_tr_sh`
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $PIN_HOME" >&5
$as_echo_n "checking for $PIN_HOME... " >&6; }
if eval \${$as_ac_File+:} false; then :
  $as_echo_n "(cached) " >&6
else
  test "$cross_compiling" = yes &&
  as_fn_error $? "cannot check for file existence when cross compiling" "$LINENO" 5
if test -r "$PIN_HOME"; then
  eval "$as_ac_File=yes"
else
  eval "$as_ac_File=no"
fi
...
if eval test \"x\$"$as_ac_File"\" = x"yes"; then :
  ...
  HAVE_PIN=false; { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Pin not found. BAP pintraces will be unavailable." >&5
$as_echo "$as_me: WARNING: Pin not found. BAP pintraces will be unavailable." >&2;}
fi


 if test x$HAVE_PIN = xtrue; then
  HAVE_PIN_TRUE=
  HAVE_PIN_FALSE='#'
else
  HAVE_PIN_TRUE='#'
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking llvm ocaml libraries" >&5
$as_echo_n "checking llvm ocaml libraries... " >&6; }

# Check whether --with-llvm was given.
if test "${with_llvm+set}" = set; then :
  withval=$with_llvm; LIBLLVM="$withval"
else
  LIBLLVM="check"
fi


if test x$LIBLLVM = xno; then :
  LLVM_PACKAGE=""
else
  if test x$LIBLLVM = xyes -o x$LIBLLVM = xcheck; then :
  if ocamlfind query llvm >/dev/null 2>&1; then :
  LLVM_PACKAGE="llvm"
else
  if ocamlfind query llvm-3_1 >/dev/null 2>&1; then :
  ...
  if ocamlfind query $LIBLLVM >/dev/null 2>&1; then :
  LLVM_PACKAGE="$LIBLLVM"
fi
fi
fi

if test \( x$LIBLLVM != xno -a x$LIBLLVM != xcheck \) -a x$LLVM_PACKAGE = x; then :
  { { $as_echo "$as_me:${as_lineno-$LINENO}: error: in \`$ac_pwd':" >&5
$as_echo "$as_me: error: in \`$ac_pwd':" >&2;}
as_fn_error $? "--with-llvm specified but llvm was not found
See \`config.log' for more details" "$LINENO" 5; }
fi



if test x$LLVM_PACKAGE != x; then :
  HAVE_LLVM_AC=yes
else
  HAVE_LLVM_AC=no
fi
if test x$HAVE_LLVM_AC = xyes; then :
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $HAVE_LLVM_AC ($LLVM_PACKAGE)" >&5
$as_echo "$HAVE_LLVM_AC ($LLVM_PACKAGE)" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $HAVE_LLVM_AC" >&5
$as_echo "$HAVE_LLVM_AC" >&6; }
fi



if test "x$HAVE_LLVM_AC" = "xtrue"; then :
...
if which etags >/dev/null 2>&1; then :
  ...
  HAVE_ETAGS=false; { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: ETAGS not found. BAP will not build tags." >&5
$as_echo "$as_me: WARNING: ETAGS not found. BAP will not build tags." >&2;}
fi

 if test x$HAVE_ETAGS = xtrue; then
  HAVE_ETAGS_TRUE=
  HAVE_ETAGS_FALSE='#'
else
  HAVE_ETAGS_TRUE='#'
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for camomile" >&5
$as_echo_n "checking for camomile... " >&6; }
ocamlfind query camomile >/dev/null 2>&1
if test $? != 0; then
   { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
   as_fn_error $? "camomile ocaml package not found" "$LINENO" 5
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: yes" >&5
$as_echo "yes" >&6; }
...
_ACEOF
  ...
  as_fn_error $? "Iberty library not found" "$LINENO" 5
fi

{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for pcre_config in -lpcre" >&5
$as_echo_n "checking for pcre_config in -lpcre... " >&6; }
if ${ac_cv_lib_pcre_pcre_config+:} false; then :
  $as_echo_n "(cached) " >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lpcre  $LIBS"
...
_ACEOF
if ac_fn_c_try_link "$LINENO"; then :
  ac_cv_lib_pcre_pcre_config=yes
else
  ac_cv_lib_pcre_pcre_config=no
fi
rm -f core conftest.err conftest.$ac_objext \
    conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_pcre_pcre_config" >&5
$as_echo "$ac_cv_lib_pcre_pcre_config" >&6; }
if test "x$ac_cv_lib_pcre_pcre_config" = xyes; then :
  cat >>confdefs.h <<_ACEOF
...
BAP_DIR="$( cd "$( dirname "${BASH_SOURCE0}" )" && pwd )"
...
for ac_header in fcntl.h stdint.h stdlib.h string.h unistd.h
do :
  as_ac_Header=`$as_echo "ac_cv_header_$ac_header" | $as_tr_sh`
...
_ACEOF
  ...
  as_fn_error $? "Standard headers missing" "$LINENO" 5
fi
...
if test "x$ac_cv_header_bfd_h" = xyes; then :
  ...
  as_fn_error $? "You need BFD headers (e.g., libbfd-dev)" "$LINENO" 5
fi
...
if test "x$ac_cv_header_pcre_h" = xyes; then :
  ...
  as_fn_error $? "You need libpcre headers (e.g., libpcre3-dev)" "$LINENO" 5
fi
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking size of bfd_vma" >&5
$as_echo_n "checking size of bfd_vma... " >&6; }
if ${ac_cv_sizeof_bfd_vma+:} false; then :
  $as_echo_n "(cached) " >&6
else
  if ac_fn_c_compute_int "$LINENO" "(long int) (sizeof (bfd_vma))" "ac_cv_sizeof_bfd_vma"        "#include <bfd.h>
"; then :

else
  if test "$ac_cv_type_bfd_vma" = yes; then
     { { $as_echo "$as_me:${as_lineno-$LINENO}: error: in \`$ac_pwd':" >&5
$as_echo "$as_me: error: in \`$ac_pwd':" >&2;}
as_fn_error 77 "cannot compute sizeof (bfd_vma)
See \`config.log' for more details" "$LINENO" 5; }
   else
     ac_cv_sizeof_bfd_vma=0
   fi
fi

fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_sizeof_bfd_vma" >&5
$as_echo "$ac_cv_sizeof_bfd_vma" >&6; }



cat >>confdefs.h <<_ACEOF
#define SIZEOF_BFD_VMA $ac_cv_sizeof_bfd_vma
_ACEOF
...
for ac_func in bzero memset strstr strtoul
do :
...
ac_config_files="$ac_config_files Makefile libasmir/Makefile libasmir/apps/Makefile libasmir/src/Makefile libtracewrap/Makefile ocaml/Makefile utils/Makefile tests/Makefile"
...
if test -z "${HAVE_PIN_TRUE}" && test -z "${HAVE_PIN_FALSE}"; then
  as_fn_error $? "conditional \"HAVE_PIN\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
if test -z "${HAVE_ETAGS_TRUE}" && test -z "${HAVE_ETAGS_FALSE}"; then
  as_fn_error $? "conditional \"HAVE_ETAGS\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
...
ac_log="
This file was extended by Bap $as_me 0.7, which was
generated by GNU Autoconf 2.68.  Invocation command line was
...
do
  case $ac_config_target in
    "libasmir/config.h") CONFIG_HEADERS="$CONFIG_HEADERS libasmir/config.h" ;;
    "depfiles") CONFIG_COMMANDS="$CONFIG_COMMANDS depfiles" ;;
    "Makefile") CONFIG_FILES="$CONFIG_FILES Makefile" ;;
    "libasmir/Makefile") CONFIG_FILES="$CONFIG_FILES libasmir/Makefile" ;;
    "libasmir/apps/Makefile") CONFIG_FILES="$CONFIG_FILES libasmir/apps/Makefile" ;;
    "libasmir/src/Makefile") CONFIG_FILES="$CONFIG_FILES libasmir/src/Makefile" ;;
    "libtracewrap/Makefile") CONFIG_FILES="$CONFIG_FILES libtracewrap/Makefile" ;;
